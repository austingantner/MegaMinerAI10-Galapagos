...
public class Creature : Mappable
{
    ...
    public int GenericHeuristic
    {
        get
        {
            //if (BaseAI.turnNumber() <= 500)
            //{
            //    return Carnivorism + Speed;
            //}
            //return Carnivorism + Herbivorism + Defense + Speed + Energy + Speed + max;
            return (10 * Speed) + (4 * Herbivorism) + (7*Carnivorism) + Defense + (2*Energy);
        }
    }
    ...
    public int min
    {
        get
        {
            return Math.Min(Carnivorism, Math.Min(Herbivorism, Math.Min(Defense, Math.Min(Speed, Energy))));
        }
    }
    ...
    public int max
    {
        get
        {
            return Math.Max(Carnivorism, Math.Max(Herbivorism, Math.Max(Defense, Math.Max(Speed, Energy))));
        }
    }
