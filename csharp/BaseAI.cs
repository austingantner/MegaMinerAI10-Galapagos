...
public abstract class BaseAI
{
  ...
  public static int getCreatureAtLocation(int x, int y)
  {
  ...
  public static int getPlantAtLocation(int x, int y)
  {
